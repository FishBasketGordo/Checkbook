...
IF NOT EXISTS (
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE
        ...
        AND ROUTINE_NAME = 'BillFrequencyHistory_SELECT'
)
BEGIN
    EXEC ('CREATE PROCEDURE [dbo].[BillFrequencyHistory_SELECT] AS BEGIN PRINT ''Stub Procedure for [dbo].[BillFrequencyHistory_SELECT]'' END')
END
GO

ALTER PROCEDURE [dbo].[BillFrequencyHistory_SELECT]
(
