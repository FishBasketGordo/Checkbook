...
IF NOT EXISTS (
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE
        ...
        AND ROUTINE_NAME = 'TransactionHistory_SELECT'
)
BEGIN
    EXEC ('CREATE PROCEDURE [dbo].[TransactionHistory_SELECT] AS BEGIN PRINT ''Stub Procedure for [dbo].[TransactionHistory_SELECT]'' END')
END
GO

ALTER PROCEDURE [dbo].[TransactionHistory_SELECT]
(
