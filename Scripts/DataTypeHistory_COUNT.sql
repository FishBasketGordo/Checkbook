...
IF NOT EXISTS (
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE
        ...
        AND ROUTINE_NAME = 'DataTypeHistory_COUNT'
)
BEGIN
    EXEC ('CREATE PROCEDURE [dbo].[DataTypeHistory_COUNT] AS BEGIN PRINT ''Stub Procedure for [dbo].[DataTypeHistory_COUNT]'' END')
END
GO

ALTER PROCEDURE [dbo].[DataTypeHistory_COUNT]
(
