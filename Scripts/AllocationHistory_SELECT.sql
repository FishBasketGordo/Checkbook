...
IF NOT EXISTS (
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE
        ...
        AND ROUTINE_NAME = 'AllocationHistory_SELECT'
)
BEGIN
    EXEC ('CREATE PROCEDURE [dbo].[AllocationHistory_SELECT] AS BEGIN PRINT ''Stub Procedure for [dbo].[AllocationHistory_SELECT]'' END')
END
GO
