...
IF NOT EXISTS (
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE
        ...
        AND ROUTINE_NAME = 'UserHistory_COUNT'
)
BEGIN
    EXEC ('CREATE PROCEDURE [dbo].[UserHistory_COUNT] AS BEGIN PRINT ''Stub Procedure for [dbo].[UserHistory_COUNT]'' END')
END
GO

ALTER PROCEDURE [dbo].[UserHistory_COUNT]
(
