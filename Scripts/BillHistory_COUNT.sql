...
IF NOT EXISTS (
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE
        ...
        AND ROUTINE_NAME = 'BillHistory_COUNT'
)
BEGIN
    EXEC ('CREATE PROCEDURE [dbo].[BillHistory_COUNT] AS BEGIN PRINT ''Stub Procedure for [dbo].[BillHistory_COUNT]'' END')
END
GO

ALTER PROCEDURE [dbo].[BillHistory_COUNT]
(
